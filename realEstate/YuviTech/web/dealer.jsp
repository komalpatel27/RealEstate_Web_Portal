...
<br/><a href="PChange.action">Change Password</a></h1>
        </div>

<div id="div2" style="float:left;position:relative; margin-left: -70px;margin-top: 0px;width: 190px; height:inherit;"><blink><b style="color: red;">Offers/Scheme</b></blink>
    <% 
        out.println("<marquee direction=\"up\" style=\"height:300px;\" loop=\"INFINITE\" behaviour=\"\" scrollamount=\"5\" vspace=\"\" onmouseover=\"this.stop()\"  onmouseout=\"this.start()\">");
    ResultSet rs = db.DBConnect.getOfferScheme();
        ...
        out.println("<table border=0 style=\"height:auto;border:1px solid black; width:120px; margin-left:0px;\">");
        out.println("<tr>");
        out.println("<td>");
